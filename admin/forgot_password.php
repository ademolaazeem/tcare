                ...
                <div class="x_content">
                  ...
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post">
                     ...
                     <!-- <input type="hidden" id="carerid" name="carerid"  maxlength="50" />
                          ...
                          <label class="control-label col-md-3 col-sm-3 col-xs-12">User Type<span class="included">*</span>
                          </label>
                          <div class="col-md-6 col-sm-6 col-xs-12">
                         <select id="userType" name="userType" data-placeholder="User Type..." class="form-control col-md-7 col-xs-12" included>
                      ...
                      <div class="form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12">Email<span class="included">*</span>
                          </label>
                          <div class="col-md-6 col-sm-6 col-xs-12">
                              <input id="email" name="email" class="form-control col-md-7 col-xs-12" included="included" type="text">
                          </div>
                      </div>
