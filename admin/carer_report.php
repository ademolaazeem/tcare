...
if(isset($_POST['report'])) {
    ...
    //$search = $_POST['search'];
    $query = "
        SELECT * from tblcarer where  firstname like '%$search%' or lastname like '%$search%' or UPPER(Sex) = '".strtoupper($search)."' or
         address like '%$search%' or county like '%$search%'  or phone = '$search' or ppsnumber ='$search' or
         DateOfBirth='$search' or emailAddress ='$search' or
        username = '$search'";
}else
{
    //echo "Eles part";
    //$query = "SELECT FirstName, LastName, Address, County, Phone, PPSNumber, EmailAddress, DateOfBirth, Sex  from FROM tblcarer";
    $query = "SELECT * from tblcarer";
}
        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Carer Report <!--<small>Sample user invoice design</small>--></h2>
                            ...
                            while($row =mysqli_fetch_array($res, MYSQLI_ASSOC))
                            {
                                if($count%2 == 0)
                                {
                                    ...
                                    <tr class="even pointer">
                                        ...
                                        <td class=" "><?php echo htmlentities($row['County'], ENT_QUOTES, 'UTF-8'); ?></td>
                                        <td class=" "><?php echo htmlentities($row['Phone'], ENT_QUOTES, 'UTF-8'); ?></td>
                                        <td class=" "><?php echo htmlentities($row['PPSNumber'], ENT_QUOTES, 'UTF-8'); ?></td>
