...
$query = "
        SELECT c.CarerID carerid, ch.DateFrom DateFrom, ch.DateTo DateTo, ch.NoOfDays NoOfDays, ch.status status, ch.reason reason,
        ch.ApprovedOn FROM tblcarer c, tblcarerholiday ch where ch.CarerID=c.CarerID and ch.CarerID='$carerID' and ch.status='Booked'";
