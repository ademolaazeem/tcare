...
if(isset($_POST['report'])) {
    ...
    //$search = $_POST['search'];
    $query = "
        SELECT * from tblpatient where  firstname like '%$search%' or lastname like '%$search%' or UPPER(Sex) = '".strtoupper($search)."' or
         address like '%$search%' or county like '%$search%'  or phone = '$search' or comments like '%$search%' or
         DateOfBirth='$search' or emailAddress ='$search'";
}else
{
    //echo "Eles part";
        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Client Report <!--<small>Sample user invoice design</small>--></h2>
