          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            ...
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                ...
                <li><a><i class="fa fa-desktop"></i> Clients <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                    <li><a href="client_list.php">Clients List</a>
                    </li>
                    <li><a href="add_newclients.php">Add New Clients </a>
                    </li>
                  </ul>
                </li>
                <li><a><i class="fa fa-table"></i> Extra Covers <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
            ...
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                ...
                <li><a><i class="fa fa-windows"></i> Assign Shifts to Carers <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
