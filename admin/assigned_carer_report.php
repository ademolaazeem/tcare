...
if(isset($_POST['report'])) {
    ...
    $search = $_POST['search'];
    $query = "
        SELECT  c.carerid carerid, concat(c.firstname,' ', c.lastname) as carername, c.Phone, concat(pt.FirstName, ' ', pt.LastName) as patientname,
        pt.PatientID patientid, pt.comments, cr.CarerRosterID, cr.DateFrom DateFrom, cr.DateTo DateTo FROM tblcarer c,
        tblcarerroster cr, tblpatient pt where c.CarerID=cr.CarerID and pt.PatientID = cr.PatientID and
        (c.firstname like '%$search%' or c.lastname like '%$search%' or pt.firstname like '%$search%' or pt.lastname like '%$search%'
        or cr.DateFrom='".strtotime($search)."' or cr.DateTo='".$search."' or c.Phone = '$search' or pt.phone='$search')";
}else
{
    $query = "
        SELECT  c.carerid carerid, concat(c.firstname,' ', c.lastname) as carername, c.Phone, concat(pt.FirstName, ' ', pt.LastName) as patientname,
        pt.PatientID patientid, pt.comments, cr.CarerRosterID, cr.DateFrom DateFrom, cr.DateTo DateTo FROM tblcarer c,
        tblcarerroster cr, tblpatient pt where c.CarerID=cr.CarerID and pt.PatientID = cr.PatientID";
}
        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Carer Scheduling Report <!--<small>Sample user invoice design</small>--></h2>
