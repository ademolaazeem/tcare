...
<h2 style="color:red;font-weight:bold;text-align:center;">My Current Holidays</h2>
<p>

<a href="carer_my_past_holidays.php"style="color:green;background:white;">My Past Holidays</a> |
<a href="book_holiday_carer.php"style="color:green;background:white;">Book My Holidays</a> <br>|
...
<?php 
    ...
    $query = " 
			...
			where carerid = :carerid and (CURDATE() between datefrom and dateto)
		order by datefrom
  	";
