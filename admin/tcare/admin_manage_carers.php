...
<?php 
    ...
    $rows = $stmt->fetchAll(); 
?> 
<h1>Carer List</h1> <br><br> <a href=admin_approve_holidays.php> Approve Carer Holidays</a>  |  |  <a href=admin_view_carer_holidays.php> View Approved Holidays
<table> 
    <tr> 
        <th>ID</th> 
        <th>Username</th> 
    ...
    <?php foreach($rows as $row): ?> 
        <tr> 
            <td><?php echo $row['carerid']; ?></td> <!-- htmlentities is not needed here because $row['id'] is always an integer --> 
	    ...
	    <td><?php echo htmlentities($row['active'], ENT_QUOTES, 'UTF-8'); ?></td>  
<td><a href=admin_edit_carer.php?carerid=<?php echo $row['carerid']; ?>> Edit Account</a></td>
