...
<ul class="left">
<li class="divider"></li>
<li class="active"><a href="edit_carer_account.php"style="color:red;background:white;">Edit My Account</a></li>
<li class="divider"></li>
...
<?php 
    ...
    { 
        ...
        $query_params = array( 
            ':emailaddress' => $_POST['emailaddress'], 
            ':carer_id' => $_SESSION['user']['carerid'], 
        ); 
        ...
        header("Location: private_Carer.php"); 
         
        // Calling die or exit after performing a redirect using the header function 
        // is critical.  The rest of your PHP script will continue to execute and 
        // will be sent to the user if you do not die or exit. 
        die("Redirecting to private_Carer.php"); 
    } 
     
?> 
<h2 style="color:red;font-weight:bold;text-align:center;">Edit Account <?php echo htmlentities($_SESSION['user']['username'], ENT_QUOTES, 'UTF-8'); ?> !</h2>

<form action="edit_carer_account.php" method="post"> 
    Username:<br /> 
    <b><?php echo htmlentities($_SESSION['user']['username'], ENT_QUOTES, 'UTF-8'); ?></b> 
    <br /><br /> 
    E-Mail Address:<br /> 
    <input type="text" name="emailaddress" value="<?php echo htmlentities($_SESSION['user']['emailaddress'], ENT_QUOTES, 'UTF-8'); ?>" /> 
    <br /><br /> 
    Password:<br /> 
