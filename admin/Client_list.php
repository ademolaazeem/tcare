        ...
        <div class="left_col scroll-view">
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                ...
                <li><a><i class="fa fa-edit"></i> Carers <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                   <li><a href="manage_carer.php">Manage Carer</a>
                    ...
                    <li><a href="manage_careholiday.php">Manage Carer Holiday</a>
                    </li>
                  </ul>
                </li>
            ...
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                <li><a><i class="fa fa-bug"></i> Assign Shifts to Carers <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                  ...
                  <table id="example" class="table table-striped responsive-utilities jambo_table">
                    ...
                    <tbody>
                      <tr class="even pointer">
                        ...
                        <td class=" ">1</td>
                        <td class=" ">Maura </td>
                        <td class=" ">Carrol <i class="success fa fa-long-arrow-up"></i>
                        </td>
                        <td class=" ">Male</td>
                        <td class=" ">01 2989114</td>
                        <td class="a-right a-right ">tplux4real</td>
                        <td class=" last"><a href="#">Edit Account</a>
                        </td>
                      </tr>
